...
build/src/autotester/autotester tests/system_tests/iteration-2/set1/source-1.txt tests/system_tests/iteration-2/set1/1-multi.txt tests/system_tests/output/iteration2-1-multi.xml

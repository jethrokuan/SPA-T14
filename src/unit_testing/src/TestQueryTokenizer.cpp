...
TEST_CASE("Test one assignment one select Tokenization") {
    ...
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(tokenStruct.such_that_tokens == nullptr);
    REQUIRE(tokenStruct.pattern_tokens == nullptr);
}
...
TEST_CASE("Test two assignments one select Tokenization") {
    ...
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p", "statement", "w"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(tokenStruct.such_that_tokens == nullptr);
    REQUIRE(tokenStruct.pattern_tokens == nullptr);
}
...
TEST_CASE("Test one assignment one select one such that Tokenization") {
    ...
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(*(tokenStruct.such_that_tokens) == std::vector<std::string>{"such", "that", "x", "y", "z"});
    REQUIRE(tokenStruct.pattern_tokens == nullptr);
}
...
TEST_CASE("Test one assignment one select one such that one pattern Tokenization") {
    auto qt = QE::QueryTokenizer();
    auto tokenStruct = qt.getTokens("assign p;Select p such that x y z pattern a b c d");
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(*(tokenStruct.such_that_tokens) == std::vector<std::string>{"such", "that", "x", "y", "z"});
    REQUIRE(*(tokenStruct.pattern_tokens) == std::vector<std::string>{"pattern", "a", "b", "c", "d"});
}
...
TEST_CASE("Test two assignment one select one such that Tokenization") {
    auto qt = QE::QueryTokenizer();
    auto tokenStruct = qt.getTokens("assign p;statement w;Select p such that x y z");
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p", "statement", "w"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(*(tokenStruct.such_that_tokens) == std::vector<std::string>{"such", "that", "x", "y", "z"});
    REQUIRE(tokenStruct.pattern_tokens == nullptr);
...
TEST_CASE("Test two assignment one select one such that one pattern Tokenization") {
    auto qt = QE::QueryTokenizer();
    auto tokenStruct = qt.getTokens("assign p;statement w;Select p such that x y z pattern a b c d");
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p", "statement", "w"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(*(tokenStruct.such_that_tokens) == std::vector<std::string>{"such", "that", "x", "y", "z"});
    REQUIRE(*(tokenStruct.pattern_tokens) == std::vector<std::string>{"pattern", "a", "b", "c", "d"});
...
TEST_CASE("Test two assignment one select one pattern Tokenization") {
    auto qt = QE::QueryTokenizer();
    auto tokenStruct = qt.getTokens("assign p;statement w;Select p pattern a b c d");
    REQUIRE(*(tokenStruct.declaration_tokens) == std::vector<std::string>{"assign", "p", "statement", "w"});
    REQUIRE(*(tokenStruct.select_tokens) == std::vector<std::string>{"Select", "p"});
    REQUIRE(tokenStruct.such_that_tokens == nullptr);
    REQUIRE(*(tokenStruct.pattern_tokens) == std::vector<std::string>{"pattern", "a", "b", "c", "d"});
